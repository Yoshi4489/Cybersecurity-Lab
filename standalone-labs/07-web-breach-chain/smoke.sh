...
nmap -sT -p 8080,9091 edge-gateway >/dev/null 2>&1 || true
...
# Stage 3 — foothold: a reflected-XSS payload steals the analyst session.
...
echo "07-web-breach-chain smoke: PASS"
