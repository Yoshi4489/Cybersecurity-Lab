    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="main-nav" aria-label="Primary navigation">
          <a className="button compact primary" href="/labs">Beginner investigations</a>
      ...
      <section className="app-content">
        ...
        {view === "home" && <section className="page home-page">
          <section className="setup-card"><div><p className="eyebrow green">REBUILT BEGINNER CURRICULUM</p><h2>Investigations, now inside the portal</h2><p>Read the scenario, follow the evidence, reveal per-flag hints, and submit flags. Includes message recovery with Base64, hex, ROT13, MD5, and a toy cipher.</p></div><a className="button primary" href="/labs">Open beginner lab workspace</a></section>
