    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="main-nav" aria-label="Primary navigation">
          <a className="button compact primary" href="/labs">New beginner labs · 9</a>
      ...
      <section className="app-content">
        ...
        {view === "home" && <section className="page home-page">
          <section className="setup-card"><div><p className="eyebrow green">REBUILT BEGINNER CURRICULUM</p><h2>Nine investigations, now inside the portal</h2><p>Read the scenario, follow the evidence, reveal per-flag hints, and submit flags. Complete walkthroughs are included on the page.</p></div><a className="button primary" href="/labs">Open beginner lab workspace</a></section>
